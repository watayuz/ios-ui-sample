...
*/
+ (nonnull instancetype)showLoaderWith:(CGPathRef _Nonnull)path on:(UIView * _Nullable)view;
/**
  Creates and SHOWS a progress based loader with the given path
  :param: path Loader CGPath
  :returns: The loader that’s already being showed
*/
+ (nonnull instancetype)showProgressBasedLoaderWith:(CGPathRef _Nonnull)path on:(UIView * _Nullable)view;
/**
  Creates a loader with the given path
  :param: path Loader CGPath
  :returns: The created loader
*/
+ (nonnull instancetype)createLoaderWith:(CGPathRef _Nonnull)path on:(UIView * _Nullable)view;
/**
  Creates a progress based loader with the given path
  :param: path Loader CGPath
  :returns: The created loader
*/
+ (nonnull instancetype)createProgressBasedLoaderWith:(CGPathRef _Nonnull)path on:(UIView * _Nullable)view;
/**
  Shows the loader.
  Atention: do not use this method after creating a loader with \code
